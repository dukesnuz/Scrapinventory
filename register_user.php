    ...
    if ($rows === 0) {
      ...
      if (mysqli_affected_rows($dbc) === 1) {
        ...
        */
        ...
        $altBody = "Thank you for registering at ".SITE_NAME.".\n\n";
...
die();
        ...
        $altBody = "User registered on ".SITE_NAME.".";
        ...
        $data = array(
          ...
          'toFirstName' => 'Admin',
          'subject' => "User registred on".CONTACT_EMAIL."",
          'body'    => '<span style="color: red">Scrapinventory User Registered</span><br> '.$body. '',
          'altBody' => $altBody
        );

        sendMail($data);
        /****************************************end use phpmailer and mailgun*******************************************/
